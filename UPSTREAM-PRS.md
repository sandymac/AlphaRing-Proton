...
Tracked as issues on this fork: https://github.com/sandymac/AlphaRing-Proton/issues
(#1 Proton crash, #2 logging, #3 Wine console, #4 CE Anniversary aspect, #5 CE level-end freeze).
